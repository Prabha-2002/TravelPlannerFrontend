...
//             }, 3000); // Hide message and remove highlight after 3 seconds
//         }
//     };
...
//                 <h1 className="text-4xl font-bold text-blue-500">Trip Planner</h1>
//                 <div className="flex items-center">
//                     <span className="mr-2 text-black-900">Search for a city:</span>
...
//                             className={`rounded-full border-2 p-2 pl-4 pr-8 focus:outline-none focus:border-black transition-all duration-300 ${
//                                 highlight ? 'border-blue-500 bg-blue-100' : 'border-black'
//                             }`}
//                             ref={searchInputRef}
//                         />
...
//             {/* Main Content */}
//             <div className="pt-16"> {/* Adjust padding-top to account for the navbar height */}
...
//                             <img className="d-block w-100" src="https://www.uniqueideas.site/wp-content/uploads/50-affordable-family-friendly-summer-trips.jpg" alt="First slide" />
//                         </div>
...
//                     <h2 className="text-3xl font-semibold mb-4">About Trip Planner</h2>
...
//                     <p className="text-lg mb-4">Looking for trip advice?</p>
//                     <button
...
//     <div className="mb-12">
//         <div className="bg-gray-900 text-white py-8 px-6 rounded-lg shadow-lg text-center">
//             <h2 className="text-3xl font-bold mb-4">About Trip Planner</h2>
//             <div className="bg-gray-100 p-6 rounded-lg shadow-md mx-auto max-w-4xl">
...
//     <div className="mb-12">
//         <h2 className="text-3xl font-bold mb-6 text-center text-gray-900">Customer Reviews</h2>
...
//         <p className="text-xl font-bold mb-4 text-gray-800">Looking for trip advice?</p>
//         <button
//             onClick={handleClickHere}
...
//     const navigate = useNavigate();
//     const handleLogout = () => {
//         // Here you can add logout logic if necessary, such as clearing tokens or user data
//         navigate('/');
//     };
//     useEffect(() => {
//         const fetchLocations = async () => {
