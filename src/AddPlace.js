...
// // const AddPlace = () => {
// //     const { id } = useParams(); // This should be the location ID
...
// //             description,
// //             imageUrl,
// //             timespend, // Changed field name from `Timespend` to `timespend`
...
// //             <div className="form-container p-4 border border-light rounded">
// //                 <h2 className="text-center text-danger fw-bold mb-4">Add Place</h2>
...
//     return (
//         <div className="container d-flex justify-content-center align-items-center vh-100">
//             <div className="form-container p-4 border bg-black border-light rounded">
//                 <h2 className="text-center text-danger fw-bold mb-4">Add Place</h2>
//                 <form onSubmit={handleSubmit}>
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white  w-50 rounded-top">Selected location's Id </label>
//                         <input
//                             type="text"
//                             className="form-control"
//                             value={id}
...
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white p-2 w-50 rounded-top"> Enter the Place Name</label>
//                         <input
//                             type="text"
//                             className="form-control"
//                             value={name}
...
//                     </div>
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white  w-50 rounded-top">Enter the Description</label>
//                         <textarea
...
//                     </div>
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white w-50 rounded-top"> Enter the Image URL</label>
//                         <input
//                             type="text"
//                             className="form-control"
//                             value={imageUrl}
...
//                     </div>
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white p-3 w-50 rounded-top">Enter the Time Spent (in hrs)</label>
//                         <input
//                             type="text"
//                             className="form-control"
//                             value={timespend}
...
//     return (
//         <div className="container d-flex justify-content-center align-items-center vh-100">
//             <div className="custom-form-container p-4 border bg-black border-light rounded">
...
//                     </div>
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white p-2 w-50 rounded-top">Enter the Description</label>
//                         <textarea
//                             className="form-control custom-textarea1"
//                             value={description}
//                             onChange={(e) => setDescription(e.target.value)}
...
//                     </div>
//                     <div className="form-group mb-3">
//                         <label className="form-label bg-black text-white p-2 w-50 rounded-top">Enter the Image URL</label>
//                         <input
//                             type="text"
//                             className="form-control"
//                             value={imageUrl}
