...
// import './Suggestor.css';  // Ensure you have the CSS file for custom styles
...
//             const totalPlaces = tripDetails.numberOfDays * 2; // Two places per day
//             const uniquePlaces = places.slice(0, totalPlaces); // Ensure you have unique places
            
//             const updatedSchedules = schedules.map((schedule, dayIndex) => {
//                 const dayPlaces = uniquePlaces.slice(dayIndex * 2, dayIndex * 2 + 2);
//                 return {
//                     ...schedule,
//                     items: dayPlaces.map(place => ({
//                         time: place.timespend, // Assuming time is stored in timespend property
...
//             <h2 className="trip-schedule-heading">Must Watch Places</h2>
...
//                                         <p className="card-text">
//                                             <strong>Rate:</strong> ${hotel.rate} <br />
...
//                 </div>
//             )}
//                     <h2 className="trip-schedule-heading1">Recommendor Plan Details</h2>
//              {showRecommendorPlan && (
//     <div className="recommendor-plan-container">
//         <form className="recommendor-plan-form">
...
//             </div>
//             <div className="form-group">
//                 <label htmlFor="tripName" className="form-heading">Trip Name</label>
//                 <input
//                     type="text"
//                     id="tripName"
//                     name="tripName"
...
//             </div>
//             <div className="form-group">
//                 <label htmlFor="startDate" className="form-heading">Start Date</label>
//                 <input
//                     type="date"
//                     id="startDate"
//                     name="startDate"
...
//             </div>
//             <div className="form-group">
//                 <label htmlFor="endDate" className="form-heading">End Date</label>
//                 <input
//                     type="date"
//                     id="endDate"
//                     name="endDate"
...
//             </div>
//             <div className="form-group">
//                 <label htmlFor="numberOfDays" className="form-heading">Number of Days</label>
//                 <input
//                     type="number"
//                     id="numberOfDays"
//                     name="numberOfDays"
...
//                                             <h5><strong>Time:</strong> {item.time}hr</h5>
//                                             <p><strong>Place:</strong> {item.placeName}</p>
...
//             <div className="text-center mb-4">
//             <button className="custom-btn btn-2" onClick={handleCreateTripClick}>
//   <span class="text">Create Your Trip</span>
// </button>
...
//             <section className=" py-3 px-1mt-5">
...
//             {showRecommendorPlan && (
//                 <div className="recommendor-plan-container">
// <h2 class="trip-schedule-heading py-3 w-100  d-inline-block ">  Recommendor Plan Details</h2>
//                     <form className="recommendor-plan-form">
//                         <div className="form-group">
//                             <label htmlFor="location" className="form-heading">Location</label>
//                             <input
...
//                         </div>
//                         <div className="form-group">
//                             <label htmlFor="tripName" className="form-heading py-3  w-70 d-inline-block">Trip Name</label>
//                             <input
//                                 type="text"
//                                 id="tripName"
//                                 name="tripName"
...
//                               scheduleDay.items.map((item, index) => (
//                                 <div key={index} className="schedule-item">
//                                     <h5><strong>Time:</strong> {item.time}</h5>
//                                     <p><strong>Place:</strong> {item.placeName}</p>
//                                     <p><strong>Description:</strong> {item.description}</p>
//                                 </div>
//                             )) 
...
//             >
//                 <DialogTitle id="modal-title">Select Your Plan</DialogTitle>
//                 <DialogContent>
...
//             {showRecommendorPlan && (
//                 <div className="recommendor-plan-container">
//                     <h2 className="trip-schedule-heading py-3 w-50 d-inline-block">Recommendor Plan Details</h2>
//                     <form className="recommendor-plan-form">
//                         <div className="form-group">
//                             <label htmlFor="location" className="form-heading">Location</label>
//                             <input
